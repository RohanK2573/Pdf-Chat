...
- `CLERK_JWT_ISSUER` (required, used to verify Clerk JWT signature/issuer)
- `CLERK_AUDIENCE` (optional, recommended in production)
- `CLERK_AUTHORIZED_PARTY` (optional, recommended in production for frontend origin pinning)
